...
class AppPalette extends ThemeExtension<AppPalette> {
  ...
  // ─── Koyu tema ────────────────────────────────────────────────────────────
    static const AppPalette dark = AppPalette(
      ...
      brand: Color(0xFF00FF41), // Siber Kalkan Neon Yeşil
      brandOn: Color(0xFF000000), // Siyah metin
      brandInk: Color(0xFF00FF41),
      brandSoft: Color(0xFF0A2210),
      ...
      bubbleOutgoing: Color(0xFF00FF41),
      bubbleOutgoingText: Color(0xFF000000),
    );
